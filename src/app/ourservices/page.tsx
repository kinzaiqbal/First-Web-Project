      ...
      <section className="min-h-screen flex flex-col items-center justify-center bg-blue-100 py-10">
        <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-3xl text-center">
          ...
          <p className="text-lg text-gray-600">
            ...
            <br /><br />
            Whether you are a beginner or looking to deepen your knowledge, our flexible scheduling options allow you to learn at your own pace and on your own time. Access live and recorded sessions from anywhere, and enjoy the convenience of learning whenever it fits into your schedule. 
            <br /><br />
